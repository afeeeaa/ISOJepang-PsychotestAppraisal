<nav
    ...
    <div class="flex items-center gap-3">
        <x-dropdown align="right" width="48">
            <x-slot name="trigger">
                <button
                    class="flex items-center p-2 text-sm font-medium text-gray-500 rounded-md transition duration-150 ease-in-out hover:text-gray-700 dark:focus:ring-offset-dark-eval-1 dark:text-gray-400 dark:hover:text-gray-200"
                >
            ...
            <x-slot name="content">
                <!-- Profile -->
                <x-dropdown-link
                    :href="route('profile.profil.edit')"
                >
                    {{ __('Ubah Profil') }}
                </x-dropdown-link>
                 ...
                 <!-- Profile -->
                 <x-dropdown-link
                    :href="route('profile.sandi.sandi')"
                >
                    {{ __('Ubah Kata Sandi') }}
                </x-dropdown-link>
